...
def get_dataloader(opt, train=True, pretensor_transform=False, min_width=0, finetune=False):
    ...
    if finetune:
        dataset = torch.utils.data.random_split(dataset, [int(0.99 * len(dataset)), int(0.01 * len(dataset))],
